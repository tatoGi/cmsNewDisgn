...
<div class="row">
    <div class="col-xl-12" style="padding: 30px">
        <div class="card-box">
            ...
            <form action="/{{ app()->getLocale() }}/admin/users/add" enctype="multipart/form-data" method="POST"  data-parsley-validate novalidate>
                @csrf
                <div class="form-group">
                    ...
                    <input type="text" name="name" parsley-trigger="change" required placeholder="Enter user name"
                        class="@error('name') danger @enderror form-control" id="userName">
                </div>
                <div class="form-group">
                    ...
                    <input type="email" name="email" parsley-trigger="change" required placeholder="Enter email"
                        class="@error('email') danger @enderror form-control" id="emailAddress">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input data-parsley-equalto="#pass1" type="password" placeholder="Password" name="re_password"
                        class="form-control @error('re_password') danger @enderror" id="passWord2" required>
                </div>
